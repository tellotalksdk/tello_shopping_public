package com.tilismtech.tellotalk_shopping_sdk_app.repository;
...
import com.tilismtech.tellotalk_shopping_sdk_app.TelloApplication;
import com.tilismtech.tellotalk_shopping_sdk_app.managers.TelloPreferenceManager;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.requestbody.AddBank;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.requestbody.AddWallet;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.requestbody.DeleteBranchAddress;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.requestbody.DeleteCardorWallet;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.requestbody.GenerateToken;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.AddBankResponse;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.AddWalletResponse;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.BankListResponse;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.CityListResponse;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.ClientWalletDetailResponse;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.ColorThemeResponse;
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.DeleteBankResponse;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.GTResponse;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.GetUserBankDetailResponse;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.ShopExistResponse;
...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.WalletListResponse;
...
public class Repository {
    ...
    public void setShopBasicSetting(MutableLiveData<ShopBasicSettingResponse> shopBasicSettingResponseMutableLiveData, ShopBasicSetting shopBasicSetting, Context myContext) {
        ...
        RequestBody LatSEC = RequestBody.create(MediaType.parse("text/plain"), shopBasicSetting.getSecondarylatitude());
        RequestBody LongSEC = RequestBody.create(MediaType.parse("text/plain"), shopBasicSetting.getSecondarylongitude());

        getRetrofitClient().setShopBasicSetting("Bearer " + TelloPreferenceManager.getInstance(myContext).getAccessToken(),
                ShopProfile, ShippingFee, tax, Province, Area, City, Country, Shop_Theme, ProfileId, Lat, Long ,LatSEC , LongSEC
    ...
    public void setShopBasicSettingWithOutImage(MutableLiveData<ShopBasicSettingResponse> shopBasicSettingResponseMutableLiveData, ShopBasicSetting shopBasicSetting, Context myContext) {
        ...
        getRetrofitClient().setShopBasicSetting_WithOut_Image("Bearer " + TelloPreferenceManager.getInstance(myContext).getAccessToken(),
                ShippingFee, tax, Province, Area, City, Country, Shop_Theme, ProfileId, Lat, Long,LatSec,LongSec
        ).enqueue(new Callback<ShopBasicSettingResponse>() {
            @Override
            public void onResponse(Call<ShopBasicSettingResponse> call, Response<ShopBasicSettingResponse> response) {
                if (response.body() != null) {
