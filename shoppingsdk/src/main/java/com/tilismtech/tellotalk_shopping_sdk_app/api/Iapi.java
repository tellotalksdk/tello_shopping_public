...
import com.tilismtech.tellotalk_shopping_sdk_app.pojos.responsebody.ProductCategoryListResponse;
...
public interface Iapi {
 ...
 /*   @Headers({
    ...
    Call<ShopBasicSettingResponse> setShopBasicSetting(@Header("Authorization") String token,
                                                       ...
                                                       @Part("secondarylatitude") RequestBody LATSEC,
                                                       @Part("secondarylongitude") RequestBody LONGSEC
    );
