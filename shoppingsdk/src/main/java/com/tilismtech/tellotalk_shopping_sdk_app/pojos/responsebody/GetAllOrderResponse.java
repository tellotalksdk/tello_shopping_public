...
public class GetAllOrderResponse {
    ...
    public class Request {
        ...
        @Expose
        private List<GetOrderByStatusResponse.ProductsDetail> productsDetails = null;
        ...
        public List<GetOrderByStatusResponse.ProductsDetail> getProductsDetails() {
            return productsDetails;
        }

        public void setProductsDetails(List<GetOrderByStatusResponse.ProductsDetail> productsDetails) {
