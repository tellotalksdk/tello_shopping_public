...
public class ShopLandingFragment extends Fragment implements ProductListAdapter.OnProductEditorClickDialog {
    ...
    private List<ProductListResponse.Request> productListAppend, dummy;
    private List<String> imageIds;
    private String video, document;
                ...
                uploadProduct.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (TextUtils.isEmpty(et_OriginalPrice.getText().toString()) ||
                            ...
                            Toast.makeText(getActivity(), getResources().getString(R.string.some_fields_are_missing), Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (!TextUtils.isEmpty(et_DiscountedPrice.getText().toString())) {
                                if (Integer.parseInt(et_DiscountedPrice.getText().toString()) > Integer.parseInt(et_OriginalPrice.getText().toString())) {
                                    Toast.makeText(getActivity(), getResources().getString(R.string.discounted_price_must_be_less_than_original_price), Toast.LENGTH_SHORT).show();
                                    return;
                                } else if (Integer.parseInt(et_DiscountedPrice.getText().toString()) == Integer.parseInt(et_OriginalPrice.getText().toString())) {
                                    Toast.makeText(getActivity(), getResources().getString(R.string.discounted_price_cannot_be_same_as_original_price), Toast.LENGTH_SHORT).show();
                                    return;
                                }
                            }
                ...
                if (checkEditDialogFieldsValidation()) {
                    {
                        ...
                        if (!TextUtils.isEmpty(et_VideoUrl.getText().toString())) {
                            if (!URLUtil.isValidUrl(et_VideoUrl.getText().toString())) {
                                Toast.makeText(getActivity(), getResources().getString(R.string.url_not_valid), Toast.LENGTH_SHORT).show();
                                loadingDialog.dismissDialog();
                                return;
                            }
                        }
                        ...
                        if ((et_VideoUrl.getText().toString().contains("www.youtube.com") && !document.equals("")) || TextUtils.isEmpty(et_VideoUrl.getText().toString())) {
                            ...
                            loadingDialog.dismissDialog();
                            Toast.makeText(getActivity(), getResources().getString(R.string.proper_youtube_link), Toast.LENGTH_SHORT).show();
                            return;
                        }
...
*/
        ...
        tv_deleteProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog1.setContentView(R.layout.dialog_confirm_delete_image); // here we will use same dialog for product delete
                dialog1.show();

                TextView message = dialog1.findViewById(R.id.cancelReason);
                                            ...
                                            Yes.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    shopLandingPageViewModel.dPResponse().observe(getViewLifecycleOwner(), new Observer<DeleteProductImageResponse>() {
                                                        ...
                                                        public void onChanged(DeleteProductImageResponse responseBody) {
                                                            if (responseBody != null) {
                                                                Toast.makeText(getActivity(), getResources().getString(R.string.image_removed_successfully), Toast.LENGTH_SHORT).show();
                                                                LLimages_edit.removeView(inflater);
                                                                loadingDialog1.dismissDialog();
                                                                dialog.dismiss();
                                                                shopLandingPageViewModel.dPResponse().removeObservers(getViewLifecycleOwner());
                                                            } else {
                                                                Toast.makeText(getActivity(), getResources().getString(R.string.image_not_removed), Toast.LENGTH_SHORT).show();
                                                                dialog.dismiss();
                                                                loadingDialog1.dismissDialog();
                                                            }
                                                        }
            ...
            public void onChanged(ProductForEditResponse productForEditResponse) {
                if (productForEditResponse != null) {
                    ...
                    if (video.contains("www.youtube.com")) {
                        images.add("http://images.unsplash.com/photo-1611162616475-46b635cb6868?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1934&q=80");
                        // button.setVisibility(View.GONE);
